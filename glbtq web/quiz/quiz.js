/* this section is cited from others */
(function($) {
    $.fn.jquizzy = function(settings) {
        ...
        answers = [],
        introFob = '	<div class="intro-container slide-container"><a class="nav-start" href="#">Please take the quiz carefully. Are you ready？<br/><br/><span><img src="'+config.startImg+'"></span></a></div>	',
        exitFob = '<div class="results-container slide-container"><div class="question-number">' + config.endText + '</div><div class="result-keeper"></div></div><div class="notice">Please choose one！</div><div class="progress-keeper" ><div class="progress"></div></div>',
        contentFob = '',
        ...
        for (questionsIteratorIndex = 0; questionsIteratorIndex < config.questions.length; questionsIteratorIndex++) {
            ...
            if (questionsIteratorIndex < config.questions.length - 1) {
                ...
                contentFob += '<div class="next final">Done</div>';
            }
            contentFob += '</div></div>';
        ...
        superContainer.find('.final').click(function() {
            ...
            resultSet = '<h2 class="qTitle">' + judgeSkills(score) + '<br/> Score： ' + score + '</h2>' + shareButton + '<div class="jquizzy-clear"></div>' + resultSet + '<div class="jquizzy-clear"></div>';
